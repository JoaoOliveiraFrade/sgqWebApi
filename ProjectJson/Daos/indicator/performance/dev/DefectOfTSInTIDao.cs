...
{
	public class DefectOfTSInTIDao
    {
		private Connection connection;

		public DefectOfTSInTIDao()
		{
        ...
        {
            string sql = File.ReadAllText(HttpContext.Current.Server.MapPath(@"~\sqls\indicator\performance\dev\defectOfTSInTI\data.sql"), Encoding.Default);
        ...
        public IList<DefectOfTSInTI> dataFbyProject(string subproject, string delivery) {
            string sql = File.ReadAllText(HttpContext.Current.Server.MapPath(@"~\sqls\indicator\performance\dev\defectOfTSInTI\dataFbyProject.sql"), Encoding.Default);

...
where 
	...
	and h.subprojeto + h.delivery collate Latin1_General_CI_AS in (@selectedProject)
...
where
	...
	and cts.dt_execucao <> ''
	and cts.ciclo = 'TI'
	and cts.subprojeto + cts.delivery collate Latin1_General_CI_AS in (@selectedProject)
